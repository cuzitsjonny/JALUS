...
void Server::init(ServerRole serverRole)
{
	...
	Characters::init("Characters", "id BIGINT(20) PRIMARY KEY, account_id BIGINT(20), name CHAR(32), unapproved_name CHAR(32), is_unapproved_name_rejected TINYINT(1), level INT(11) NOT NULL DEFAULT 1, inventory_size INT(11) NOT NULL DEFAULT 24, universe_score BIGINT(20) NOT NULL DEFAULT 0, currency BIGINT(20) NOT NULL DEFAULT 0, reputation BIGINT(20) NOT NULL DEFAULT 0, gm_level INT(11)");
