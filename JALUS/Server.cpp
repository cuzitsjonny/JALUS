...
void Server::init(ServerRole serverRole)
{
	...
	Characters::init("Characters", "id BIGINT(20) PRIMARY KEY, account_id BIGINT(20), name CHAR(32), unapproved_name CHAR(32), is_unapproved_name_rejected TINYINT(1), level INT(11) NOT NULL DEFAULT 1, max_inventory INT(11) NOT NULL DEFAULT 20, max_health INT(11) NOT NULL DEFAULT 4, max_imagination INT(11) NOT NULL DEFAULT 0, universe_score BIGINT(20) NOT NULL DEFAULT 0, currency BIGINT(20) NOT NULL DEFAULT 0, reputation BIGINT(20) NOT NULL DEFAULT 0, gm_level INT(11) NOT NULL DEFAULT 0");
	...
	InventoryItems::init("InventoryItems", "id BIGINT(20) PRIMARY KEY, owner_id BIGINT(20), item_type TINYINT(2), inventory_type TINYINT(2), slot SMALLINT(6), count INT(11), is_bound TINYINT(1), is_equipped TINYINT(1), is_proxy TINYINT(1)");
...
bool Server::start()
{
	...
	Server::peerInterface->InitializeSecurity(0,0,0,0);
