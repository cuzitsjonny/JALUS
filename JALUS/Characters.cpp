...
long Characters::getHealth(long long charID)
{
	SAConnection con;
	SACommand cmd;
...
long Characters::getArmor(long long charID)
{
	SAConnection con;
	SACommand cmd;
...
long Characters::getImagination(long long charID)
{
	SAConnection con;
	SACommand cmd;
	...
	try
	{
		...
		if (cmd.FetchFirst())
			r = cmd.Field("imagination").asLong();
...
void Characters::setHealth(long health, long long charID)
{
	SAConnection con;
	SACommand cmd;
...
void Characters::setArmor(long armor, long long charID)
{
	SAConnection con;
	SACommand cmd;
...
void Characters::setImagination(long imagination, long long charID)
{
	SAConnection con;
	SACommand cmd;
	...
	try
	{
		...
		ss << "UPDATE";
		ss << " " << Characters::name << " ";
		ss << "SET imagination = '" << imagination << "' ";
		ss << "WHERE id = '" << charID << "';";
